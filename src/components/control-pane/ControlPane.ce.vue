...
const props = withDefaults(
    defineProps<{
        /**
         * Flag to force the control pane to take the full width
         */
        fullWidth?: boolean;
    }>(),
    { fullWidth: false },
